...
def remove_silence(filename, out_dir, smoothing=1.0, weight=0.3, plot=False):
    ...
    if is_segmentable(partic_id):
        ...
        segments = aS.silence_removal(x, Fs, 0.020, 0.020, smooth_window=smoothing,
                                      weight=weight,
                                      plot=plot)
...
if __name__ == '__main__':
    ...
    dir_name = '/mnt/xlancefs/home/rtg99/data/raw/audio'

    # directory where a participant folder will be created containing their
    # segmented wav file
    out_dir = '/mnt/xlancefs/home/rtg99/data/interim'
