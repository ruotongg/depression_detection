...
def rand_samp_train_test_split(npz_file_dir):
    ...
    dep_samps = [f for f in npz_files if f.startswith('D_mfcc')]
    norm_samps = [f for f in npz_files if f.startswith('N_mfcc')]
...
if __name__ == '__main__':
    ...
    np.savez('/mnt/xlancefs/home/rtg99/data/npz/train_samples_mfcc.npz', train_samples)
    np.savez('/mnt/xlancefs/home/rtg99/data/npz/train_labels_mfcc.npz', train_labels)
    np.savez('/mnt/xlancefs/home/rtg99/data/npz/test_samples_mfcc.npz', test_samples)
    np.savez('/mnt/xlancefs/home/rtg99/data/npz/test_labels_mfcc.npz', test_labels)
